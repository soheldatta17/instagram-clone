      ...
      <div className="flex flex-col items-center gap-8 py-8 md:flex-row md:items-start">
        ...
        <div className="flex-grow text-center md:text-left">
          <div className="flex flex-col items-center gap-4 md:flex-row">
            <h1 className="text-2xl font-semibold">sarah.designs</h1>
          ...
          <div className="flex justify-center gap-8 my-4 md:justify-start">
            <span><b>324</b> posts</span>
            <span><b>8.2k</b> followers</span>
            <span><b>642</b> following</span>
          </div>
          <p className="max-w-md">
            Digital artist & designer 🎨
            Creating beautiful things daily ✨
